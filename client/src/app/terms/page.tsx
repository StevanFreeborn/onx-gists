      ...
      <article className="flex flex-col gap-6 w-full max-w-4xl">
        <section className="flex flex-col gap-2">
          ...
          <p>
            ...
            use of OnxGists&apos;s Website, located at{' '}
            <a
          ...
          <p>
            ...
            conditions. Do not continue to use OnxGists if you do not agree to
        ...
        <section className="flex flex-col gap-2">
          <HeadingLinkButton hash="cookies">
            <h2 className="text-lg font-bold">Cookies</h2>
          </HeadingLinkButton>
          <p>
            We employ the use of cookies. By accessing OnxGists, you agreed to
            use cookies in agreement with the OnxGists&apos;s Privacy Policy.
          </p>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <HeadingLinkButton hash="license">
            <h2 className="text-lg font-bold">License</h2>
          </HeadingLinkButton>
          <p>
            Unless otherwise stated, OnxGists and/or its licensors own the
            intellectual property rights for all material on OnxGists. All
            intellectual property rights are reserved. You may access this from
            OnxGists for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul className="list-disc list-inside">
            <li>Republish material from OnxGists</li>
            <li>Sell, rent or sub-license material from OnxGists</li>
            <li>Reproduce, duplicate or copy material from OnxGists</li>
            <li>Redistribute content from OnxGists</li>
          </ul>
          <p>This Agreement shall begin on the date hereof.</p>
          <p>
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            OnxGists does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of OnxGists,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, OnxGists shall
            not be liable for the Comments or for any liability, damages or
            expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>
          <p>
            OnxGists reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant OnxGists a non-exclusive license to use, reproduce,
            edit and authorize others to use, reproduce and edit any of your
            Comments in any and all forms, formats or media.
          </p>
        </section>
        <section className="flex flex-col gap-2">
          <HeadingLinkButton hash="hyperlinks-to-content">
            <h2 className="text-lg font-bold">Hyperlinking to our Content</h2>
          </HeadingLinkButton>
          <p>
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of OnxGists; and
          ...
          <p>
            ...
            sending an e-mail to OnxGists. Please include your name, your
          ...
          <p>
            No use of OnxGists&apos;s logo or other artwork will be allowed for
            linking absent a trademark license agreement.
          </p>
        </section>
        <section className="flex flex-col gap-2">
          <HeadingLinkButton hash="iFrames">
            <h2 className="text-lg font-bold">iFrames</h2>
          </HeadingLinkButton>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <HeadingLinkButton hash="content-liability">
            <h2 className="text-lg font-bold">Content Liability</h2>
          </HeadingLinkButton>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <HeadingLinkButton hash="reservation-of-rights">
        ...
        <section className="flex flex-col gap-2">
          <HeadingLinkButton hash="disclaimer">
