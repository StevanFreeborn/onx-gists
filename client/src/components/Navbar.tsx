    ...
    <nav className="bg-white border-b border-slate-500 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-between mx-auto p-4 md:flex-row">
        ...
        >
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:gap-3 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            {status === 'loading' ? (
              <li>Loading...</li>
